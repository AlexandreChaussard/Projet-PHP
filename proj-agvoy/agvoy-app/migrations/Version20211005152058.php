 ...
 */
final class Version20211005152058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE preview_image_url (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)');
        $this->addSql('ALTER TABLE region ADD COLUMN preview_image_url CLOB DEFAULT NULL');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__room AS SELECT id, owner_id, summary, description, capacity, superficy, price, address, preview_image_url, ad_image_url FROM room');
        $this->addSql('DROP TABLE room');
        $this->addSql('CREATE TABLE room (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER NOT NULL, summary CLOB NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, capacity INTEGER NOT NULL, superficy INTEGER NOT NULL, price DOUBLE PRECISION NOT NULL, address VARCHAR(255) NOT NULL COLLATE BINARY, preview_image_url CLOB DEFAULT NULL COLLATE BINARY, ad_image_url CLOB DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_729F519B7E3C61F9 FOREIGN KEY (owner_id) REFERENCES owner (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO room (id, owner_id, summary, description, capacity, superficy, price, address, preview_image_url, ad_image_url) SELECT id, owner_id, summary, description, capacity, superficy, price, address, preview_image_url, ad_image_url FROM __temp__room');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE preview_image_url');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__room AS SELECT id, owner_id, summary, description, capacity, superficy, price, address, preview_image_url, ad_image_url FROM room');
        $this->addSql('DROP TABLE room');
        $this->addSql('CREATE TABLE room (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER NOT NULL, summary CLOB NOT NULL, description CLOB NOT NULL, capacity INTEGER NOT NULL, superficy INTEGER NOT NULL, price DOUBLE PRECISION NOT NULL, address VARCHAR(255) NOT NULL, preview_image_url CLOB DEFAULT NULL, ad_image_url CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO room (id, owner_id, summary, description, capacity, superficy, price, address, preview_image_url, ad_image_url) SELECT id, owner_id, summary, description, capacity, superficy, price, address, preview_image_url, ad_image_url FROM __temp__room');
        $this->addSql('DROP TABLE __temp__room');
        $this->addSql('CREATE INDEX IDX_729F519B7E3C61F9 ON room (owner_id)');
        $this->addSql('DROP INDEX IDX_4E2C37B754177093');
