 ...
 */
final class Version20211012135646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__room AS SELECT id, owner_id, summary, description, capacity, superficy, price, address, preview_image_name, preview_image_updated_at, ad_image_name, ad_image_updated_at FROM room');
        $this->addSql('DROP TABLE room');
        $this->addSql('CREATE TABLE room (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER NOT NULL, summary CLOB NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, capacity INTEGER NOT NULL, superficy INTEGER NOT NULL, price DOUBLE PRECISION NOT NULL, address VARCHAR(255) NOT NULL COLLATE BINARY, preview_image_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, preview_image_updated_at DATETIME DEFAULT NULL, ad_image_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, ad_image_updated_at DATETIME DEFAULT NULL, CONSTRAINT FK_729F519B7E3C61F9 FOREIGN KEY (owner_id) REFERENCES owner (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO room (id, owner_id, summary, description, capacity, superficy, price, address, preview_image_name, preview_image_updated_at, ad_image_name, ad_image_updated_at) SELECT id, owner_id, summary, description, capacity, superficy, price, address, preview_image_name, preview_image_updated_at, ad_image_name, ad_image_updated_at FROM __temp__room');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__room AS SELECT id, owner_id, summary, description, capacity, superficy, price, address, preview_image_name, preview_image_updated_at, ad_image_name, ad_image_updated_at FROM room');
        $this->addSql('DROP TABLE room');
        $this->addSql('CREATE TABLE room (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id INTEGER NOT NULL, summary CLOB NOT NULL, description CLOB NOT NULL, capacity INTEGER NOT NULL, superficy INTEGER NOT NULL, price DOUBLE PRECISION NOT NULL, address VARCHAR(255) NOT NULL, preview_image_name VARCHAR(255) DEFAULT NULL, preview_image_updated_at DATETIME DEFAULT NULL, ad_image_name VARCHAR(255) DEFAULT NULL, ad_image_updated_at DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO room (id, owner_id, summary, description, capacity, superficy, price, address, preview_image_name, preview_image_updated_at, ad_image_name, ad_image_updated_at) SELECT id, owner_id, summary, description, capacity, superficy, price, address, preview_image_name, preview_image_updated_at, ad_image_name, ad_image_updated_at FROM __temp__room');
        $this->addSql('DROP TABLE __temp__room');
        $this->addSql('CREATE INDEX IDX_729F519B7E3C61F9 ON room (owner_id)');
        $this->addSql('DROP INDEX IDX_4E2C37B754177093');
